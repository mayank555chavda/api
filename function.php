...
function storedata($storeInput){
    ...
    if($check !== false) {
        ...
        if (move_uploaded_file($_FILES["product_image"]["tmp_name"], $target_file)) {
            ...
            $query = "INSERT INTO api (product_name, product_price, product_image) VALUES ('$product_name', '$product_price', 'https://mayank.marutiinstituteofdesign.com/api/$target_file')";
