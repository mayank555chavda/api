...
function storedata($storeInput){
    ...
    if($check !== false) {
        ...
        if (move_uploaded_file($_FILES["product_image"]["tmp_name"], $target_file)) {
            ...
            $query = "INSERT INTO seller (product_name, product_price, product_image) VALUES ('$product_name', '$product_price', 'https://mayank.marutiinstituteofdesign.com/seller_api(1)/$target_file')";
...
function getCustomer($customerParams) {
    ...
    $query = "SELECT * FROM seller WHERE id = '$customerId' LIMIT 1";
...
function updateCustomer($storeInput, $customerParams) {
    ...
    $query = "UPDATE seller SET product_name = '$product_name', product_price ='$product_price' WHERE id='$customerId' LIMIT 1 ";
...
function deleteCustomer($customerParams) {
    ...
    $query = "DELETE FROM seller WHERE id='$customerId' LIMIT 1";
